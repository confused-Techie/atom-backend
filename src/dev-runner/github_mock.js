...
app.get("/repos/git-test/atom-backend/tags", (req, res) => {
  res.status(200).json([
    {
      name: "v0.219.8",
      zipball_url: "https://api.github.com/repos/pulsar-edit/find-and-replace/zipball/refs/tags/v0.219.8",
      tarball_url: "https://api.github.com/repos/pulsar-edit/find-and-replace/tarball/refs/tags/v0.219.8",
      commit: {
    ...
    {
      name: "v0.219.7",
      zipball_url: "https://api.github.com/repos/pulsar-edit/find-and-replace/zipball/refs/tags/v0.219.7",
      tarball_url: "https://api.github.com/repos/pulsar-edit/find-and-replace/tarball/refs/tags/v0.219.7",
      commit: {
...
app.use((req, res) => {
  res.status(404).json({ message: "Not Found", documentation_url: "https://docs.github.com/rest" });
});
