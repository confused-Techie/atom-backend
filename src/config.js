...
function GetConfig() {
  try {
    ...
    return {
      ...
      server_url: process.env.SERVERURL ? process.env.SERVERURL : data.env_variables.SERVERURL,
      paginated_amount: process.env.PAGINATE ? process.env.PAGINATE : data.env_variables.PAGINATE,
      search_algorithm: process.env.SEARCHALGORITHM ? process.env.SEARCHALGORITHM : data.env_variables.SEARCHALGORITHM,
