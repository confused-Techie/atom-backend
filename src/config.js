...
function getConfig() {
  ...
  return {
    ...
    GCLOUD_STORAGE_BUCKET: process.env.GCLOUD_STORAGE_BUCKET ?? data.env_variables.GCLOUD_STORAGE_BUCKET,
    GOOGLE_APPLICATION_CREDENTIALS: process.env.GOOGLE_APPLICATION_CREDENTIALS ?? data.env_variables.GOOGLE_APPLICATION_CREDENTIALS,
    ...
    GH_REDIRECTURI: process.env.GH_REDIRECTURI ?? data.env_variables.GH_REDIRECTURI,
    GH_CLIENTSECRET: process.env.GH_CLIENTSECRET ?? data.env_variables.GH_CLIENTSECRET,
